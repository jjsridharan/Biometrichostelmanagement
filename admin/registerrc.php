		...
		function Validate()
		{
			...
			$.ajax(
			{
				...
				{					
					...
					{
						alert("RC mailid already Present");						
						document.getElementById("present").hidden=false;
						var info = response.split(";");
						document.getElementById("mailid").readOnly=false;						
						document.getElementById("rname").innerHTML=info[0];
						document.getElementById("rhname").innerHTML=info[2];
						document.getElementById("rphone").innerHTML=info[1];
					}	
					document.getElementById("process").hidden=true;					
				}				
			}
  ...
  <body>
      ...
      <section class="probootstrap-section">
		...
		<div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">                  
                      ...
                      <label class="text"><i class="fa fa-envelope"></i>RC Mailid</label><br/>
		...
		<div class="col-md-7 col-md-push-1  probootstrap-animate" id="present" hidden>    
			<h2 style="color:#8000ff">RC Information</h2>
		  ...
		  <div class="col-md-7 col-md-push-1  probootstrap-animate" id="orgform" hidden>                  
                  <form method="post" action="regrc.php" onsubmit="return ValidateForm()">        
