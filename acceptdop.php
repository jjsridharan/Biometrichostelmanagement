            ...
            <ul class="nav navbar-nav navbar-right">
			  ...
			  <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
				  ...
				  <li><a href="course-single.html">Past Requests</a></li> 
                </ul>
              </li>
      ...
      <section class="probootstrap-section">
		<div class="container">
		  <div class="col-md-7 col-md-push-1  probootstrap-animate" id="orgform">                  
				...
				<?php
					$qry="select * from currentoutpass where regno='".$_SESSION['regno']."'";
					...
					if($res && mysqli_num_rows($res))
					{
						...
						{							
								echo '<tr><td>'.$row['stime'].'</td><td>'.$row['etime'].'</td><td>'.$row['reason'].'</td><td>'.$row['approvedby'].'</td></tr>';								
								$flag=0;
						}
					}
					if($flag==1)
